...
@router.post("/create")
def create_plan(db: db_dependency, plan_req: PlanRequest):
    return plan_service.create_plan(db, plan_req)

@router.put("/update/{id}")
def update_plan(id: int, db: db_dependency, plan_req: PlanRequest):
    return plan_service.update_plan(db, plan_req, id)

@router.delete("/delete/{id}")
def update_plan(id: int, db: db_dependency):
